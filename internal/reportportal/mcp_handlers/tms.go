...
func (tr *TMSResources) projectSchema() *jsonschema.Schema {
	return &jsonschema.Schema{
		Type:        "string",
		Description: "Project name",
		Default:     mustMarshalJSON(tr.defaultProject),
	}
}
...
func RegisterTMSTools(
	...
	tms := NewTMSResources(rpClient, analyticsClient, defaultProject)
